...
public class CFLookupIntegrationTests {
	...
	public void logReplacesKeyWithCFAppName() throws Exception {
		testPlaceholderIsReplaced("${cf:appName}", APP_NAME);
	}
	
	@Test
	public void logReplacesKeyWithCFSpaceName() throws Exception {
		testPlaceholderIsReplaced("${cf:spaceName}", SPACE_NAME);
	}

	private void testPlaceholderIsReplaced(String placeholder, String placeholderValue) {
